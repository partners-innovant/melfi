    ...
    <div className="flex flex-col xl:flex-row h-[calc(100vh-0px)] min-h-0">
      ...
      <Tabs value={tab} onValueChange={setTab}>
        <TabsList className="flex h-auto w-full justify-start overflow-x-auto [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
          <TabsTrigger value="profile" className="flex-shrink-0 w-fit whitespace-nowrap">Ficha Clínica</TabsTrigger>
          <TabsTrigger value="extended" className="flex-shrink-0 w-fit whitespace-nowrap">Notas</TabsTrigger>
          <TabsTrigger value="sessions" className="flex-shrink-0 w-fit whitespace-nowrap">Sesiones</TabsTrigger>
          <TabsTrigger value="history" className="flex-shrink-0 w-fit whitespace-nowrap">Consultas IA</TabsTrigger>
        ...
        <TabsContent value="profile" className="mt-4 space-y-4">
          <EditableNotesCard
            ...
            onNotesUpdated={(newNotes) => setPatient((p: any) => p ? { ...p, notes: newNotes } : p)}
          />
          <LastSessionCard
            key={refreshKey}
            kind="adult"
